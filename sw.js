const CACHE='wanxiang-v7b';
const ASSETS=['./','./index.html','./style.css','./app.js','./patch-v7.js','./v7patch.txt','./v7-fix.js','./addon.txt','./manifest.webmanifest','./icon.svg','./v2js1.txt','./v2js2.txt','./v2js3.txt','./v2js4.txt','./v2js5.txt'];
